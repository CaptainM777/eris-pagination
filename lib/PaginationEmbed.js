...
class PaginationEmbed {
     ...
     */
    constructor(textChannel, authorID, pages = [], options = {}, components, interaction) {
...
module.exports = {
     ...
     */
    createPaginationEmbed: async (textChannel, authorID, pages, options, components, interaction) => {
        const paginationEmbed = new PaginationEmbed(textChannel, authorID, pages, options, components, interaction);
