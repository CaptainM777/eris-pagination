...
class PaginationEmbed {
     ...
     */
    constructor(textChannel, authorID, pages = [], options = {}, components) {
...
module.exports = {
     ...
     * @param {components} Array<Eris.ActionRow> components to attach to the message
     */
    createPaginationEmbed: async (textChannel, authorID, pages, options, components) => {
        const paginationEmbed = new PaginationEmbed(textChannel, authorID, pages, options, components);
